# Swing Analyzer Backend

개인 골프 스윙 분석 MVP의 API 서버입니다. 미디어 업로드와 분석 실행, 채팅 응답, 분석 이력 조회/삭제, Custom GPT Action 연동을 담당합니다.
...
그 다음 `.env`를 열어 실제 값을 채웁니다. 최소 설정 항목은 다음과 같습니다.
